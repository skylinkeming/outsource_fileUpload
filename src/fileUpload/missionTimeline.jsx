...
export default function CommandProcedure() {
  ...
  const [procedureNameOptions, setProcedureNameOptions] = useState([
    initOption,
  ]);
    ...
    <StyledCommandProcedure>
      <Panel>
        <PanelBody className="p-0 topPanel">
          <p className="mb-3 title">Mission Timeline</p>
              ...
              <div className="col-lg-8">
                <div className="row gx-2">
                  <div className="col-6">
                    ...
                    <input
                      className="dateInput"
                      value={form.startDate ? form.startDate.format() : ""}
                      disabled
                    />
                  </div>
                  <div className="col-6">
                    ...
                    <input
                      className="dateInput"
                      value={form.endDate ? form.endDate.format() : ""}
                      disabled
                    />
                  </div>
                </div>
          ...
          <div className="buttonPanel">
            <button
              type="button"
              className="btn btn-info me-1 search"
              onClick={clickSubmit}
            >
              Submit
            </button>
      ...
      <Panel>
        <PanelBody className="p-0">
          <div className="panelTitle">Command</div>
            ...
            return (
              <SingleCommandPanel
                ...
                dataList={[
                  {
                    label: "UTC",
                    inputType: InputType.TimeInput,
                    value: data.UTC,
                    options: [],
                  },
                  {
                    label: "action",
                    inputType: InputType.DropdownMenu,
                    value: data.action,
                  ...
                  {
                    label: "quaternion_1",
                    inputType: InputType.CommandInput,
                    value: data.quaternion_1,
                    options: [],
                  },
                  {
                    label: "quaternion_2",
                    inputType: InputType.CommandInput,
                    value: data.quaternion_2,
                    options: [],
                  },
                  {
                    label: "quaternion_3",
                    inputType: InputType.CommandInput,
                    value: data.quaternion_3,
                    options: [],
                  },
                  {
                    label: "quaternion_4",
                    inputType: InputType.CommandInput,
                    value: data.quaternion_4,
                    options: [],
                  },
                  {
                ...
                onClickDeleteBtn={() => {
                  let targetList = commandList.filter(
