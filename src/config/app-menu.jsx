const Menu = [
  { path: '/fileUpload/imageUpload', icon: 'fab ', title: 'Image Upload'},
  { path: '/fileUpload/uploadHistory', icon: 'fab ', title: 'Upload History'},
  { path: '/fileUpload/commandProcedure', icon: 'fab ', title: 'Command Procedure'},
  { path: '/fileUpload/missionTimeline', icon: 'fab ', title: 'Mission Timeline'},
  { path:'/fileUpload/SOHDisplay', icon:'fab', title:'SOH Display'},
