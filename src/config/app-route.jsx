...
import ImageUpload from '../fileUpload/imageUpload/imageUpload.jsx';
import UploadHistory from '../fileUpload/uploadHistory/uploadHistory.jsx';
import MissionTimeline from '../fileUpload/missionTimeline.jsx';
import CommandProcedure from '../fileUpload/commandProcedure.jsx';
import SOHDisplay from '../fileUpload/sohDisplay.jsx';
...
const AppRoute = [
	{
		...
		children: [
			{
				path:'fileUpload/imageUpload',
				element:<ImageUpload/>,
			},
			{
				path:'fileUpload/uploadHistory',
				element:<UploadHistory/>,
			},
			{
				path:'fileUpload/missionTimeline',
			...
			{
				path:'fileUpload/sohDisplay',
				element:<SOHDisplay/>,
			},
			{
				path: 'fileUpload/commandProcedure',
				element: <CommandProcedure />
			},
			{
				path: 'dashboard/*',
				element: <Outlet />,
