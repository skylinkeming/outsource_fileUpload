...
class DashboardV1 extends React.Component {
	...
	render() {
		defaults.color = 'rgba(' + this.context.color.componentColorRgb + ', .65)';
		defaults.font.family = this.context.font.family;
		defaults.font.weight = 600;
		defaults.scale.grid.color = 'rgba(' + this.context.color.componentColorRgb + ', .15)';
		defaults.scale.ticks.backdropColor = 'rgba(' + this.context.color.componentColorRgb + ', 0)';
		...
		this.lineChartData = {
			...
			datasets: [{
				...
				fill: false,
				lineTension: 0.1,
				backgroundColor: 'rgba('+ this.context.color.tealRgb +', 0.25)',
				borderColor: this.context.color.teal,
				borderWidth: 2,
				pointBorderColor: this.context.color.teal,
				pointBackgroundColor: this.context.color.componentBg,
				pointBorderWidth: 2,
				pointHoverRadius: 5,
				pointHoverBackgroundColor: this.context.color.componentBg,
				pointHoverBorderColor: this.context.color.teal,
				...
				fill: false,
				lineTension: 0.1,
				backgroundColor: 'rgba('+ this.context.color.blueRgb +', 0.25)',
				borderColor: this.context.color.blue,
				borderWidth: 2,
				pointBorderColor: this.context.color.blue,
				pointBackgroundColor: this.context.color.componentBg,
				pointBorderWidth: 2,
				pointHoverRadius: 5,
				pointHoverBackgroundColor: this.context.color.componentBg,
				pointHoverBorderColor: this.context.color.blue,
				pointHoverBorderWidth: 3,
				pointRadius: 3,
				pointHitRadius: 10,
		...
		this.sparklineData = [{
			...
			colors: { area: 'transparent', line: this.context.color.red }
		}];
		
		this.sparklineData2 = [{
			values: [789, 880, 676, 200, 890, 677, 900],
			colors: { area: 'transparent', line: this.context.color.orange }
		}];
		
		this.sparklineData3 = [{
			values: [789, 880, 676, 200, 890, 677, 900],
			colors: { area: 'transparent', line: this.context.color.teal }
		}];
		
		this.sparklineData4 = [{
			values: [789, 880, 676, 200, 890, 677, 900],
			colors: { area: 'transparent', line: this.context.color.blue }
		}];
		
		this.sparklineData5 = [{
			values: [789, 880, 676, 200, 890, 677, 900],
			colors: { area: 'transparent', line: this.context.color.gray500 }
		}];
		
		this.sparklineData6 = [{
			values: [789, 880, 676, 200, 890, 677, 900],
			colors: { area: 'transparent', line: this.context.color.componentColor }
		}];
							...
							<div className="tab-pane fade" id="purchase">
								<PerfectScrollbar className="h-300px">
									<table className="table table-panel mb-0">
										...
										<tbody>
											<tr>
												<td className="fw-bold text-muted">13/02/2022</td>
								...
								<PerfectScrollbar className="h-300px p-3">
									<div className="d-flex">
										...
										<div className="flex-1 ps-3">
											...
											<span className="text-muted fs-11px fw-bold">Received on 04/16/2022, 12.39pm</span>
										</div>
									</div>
									<hr className="bg-gray-500" />
									<div className="d-flex">
