							...
							<div className="list-group list-group-flush rounded-bottom overflow-hidden panel-body p-0">
								<div className="list-group-item d-flex border-top-0">
									...
									<div className="flex-fill">
										...
										<div className="mb-1">
											<span className="badge bg-blue">docs</span>
								...
								<a href="#/" className="list-group-item list-group-item-action d-flex">
									...
									<div className="flex-fill">
										...
										<div className="mb-1">
											<span className="badge bg-gray-300 text-gray-900">build</span>
								...
								<a href="#/" className="list-group-item list-group-item-action d-flex">
									...
									<div className="flex-fill">
										...
										<div className="mb-1">
											<span className="badge bg-gray-300 text-gray-900">design</span>
							...
							<div className="list-group list-group-flush rounded-bottom overflow-hidden panel-body p-0">
								...
								<div className="list-group-item list-group-item-action d-flex">
									...
									<div className="flex-fill">
										...
										<div className="mb-1">
											<span className="badge bg-gray-300 text-gray-900">issue</span>
