								...
								<table className="table mb-0">
									...
									<tbody>
										<tr>
											...
											<td><button onClick={() => this.addNotification('success', 'Success', 'All your data has been successfully updated', 'bottom-left')} className="btn btn-sm btn-dark">Demo</button></td>
										</tr>
										<tr>
...
'<button onClick={() => this.addNotification(\'success\', \'Success\', \'All your data has been successfully updated\', \'bottom-left\')} className="btn btn-sm btn-dark">Demo</button>'
					...
					<div className="col-xl-6">
						<Panel>
							...
							<div className="hljs-wrapper">
							<Highlight className='typescript'>{
'<button data-bs-toggle="modal" data-bs-target="#modalDialog" className="btn btn-sm btn-success">Demo</button>\n'+
'\n'+
