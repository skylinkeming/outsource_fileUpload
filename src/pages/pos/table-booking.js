	...
	render() {
		return (
			<div className="vh-100">
							...
							<PerfectScrollbar className="pos-booking-content-container">
								...
								<div className="row">
									<div className="col-xl-2 col-lg-3 col-md-4 col-sm-6">
										<Link to="/pos/table-booking" data-bs-toggle="modal" data-bs-target="#modalPosBooking" className="table-booking">
				...
				<div className="modal modal-pos-booking fade" id="modalPosBooking">
					<div className="modal-dialog modal-lg">
						<div className="modal-content border-0">
							<div className="modal-body">
								<div className="d-flex align-items-center mb-3">
									<h4 className="modal-title d-flex align-items-center"><img src="../assets/img/pos/icon-table-black.svg" alt="" height="30" className="me-2" /> Table 01 <small className="fs-13px fw-bold ms-2">max 4 pax</small></h4>
								...
								<div className="row">
									<div className="col-lg-6">
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">08:00am</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">09:00am</div>
												<input type="text" className="form-control" placeholder="" defaultValue="Reserved by Sean" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">10:00am</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">11:00am</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">12:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">01:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">02:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">03:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
									</div>
									<div className="col-lg-6">
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">04:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">05:00pm</div>
												<input type="text" className="form-control" placeholder="" defaultValue="Reserved by Irene Wong (4pax)" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">06:00pm</div>
												<input type="text" className="form-control" placeholder="" defaultValue="Reserved by Irene Wong (4pax)" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">07:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">08:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">09:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-bold">10:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
									</div>
							...
							<div className="modal-footer">
								<a href="#/" className="btn btn-default w-100px" data-bs-dismiss="modal">Cancel</a>
