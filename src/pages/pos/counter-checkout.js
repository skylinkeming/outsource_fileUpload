						...
						<div className="pos-counter-sidebar" id="pos-counter-sidebar">
							...
							<div className="pos-sidebar-footer">
								...
								<div className="btn-row">
									<Link to="/pos/counter-checkout" className="btn btn-default width-150">
										<div className="icon"><i className="fa fa-qrcode fa-fw fa-lg"></i></div>
										Digital Wallet
									</Link>
									<Link to="/pos/counter-checkout" className="btn btn-default width-150">
									...
									<Link to="/pos/counter-checkout" className="btn btn-success">
